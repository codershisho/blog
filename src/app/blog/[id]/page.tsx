  ...
  return (
    <div className="flex">
      <div className="w-5/6 mx-auto md:w-4/6">
        <Link href="/blogs">
          <button type="button" className="py-2 inline-flex items-center text-sm font-semibold bg-white text-blue-600 hover:border-blue-500 hover:text-blue-500">
            一覧へ戻る
          </button>
        </Link>
        <h1 className="text-base font-bold my-4 md:text-2xl">{blog.title}</h1>
        <p className="text-xs font-semibold text-right md:text-base">{toJapanTime(blog.publishedAt)}</p>
