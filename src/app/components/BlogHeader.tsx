    ...
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap w-full text-sm py-4 bg-gradient-to-r from-gray-700 via-gray-700 to-black">
      <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        <div className="flex items-center justify-between">
          <a className="flex-none text-white font-semibold text-base md:text-lg lg:text-2xl" href="/">ShiShoの成長記録</a>
        ...
        <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
            <Link href="/">
              <div className="font-base text-slate-100 hover:underline md:text-lg" aria-current="page">Landing</div>
            </Link>
            <Link href="/blogs">
              <div className="font-base text-slate-100 hover:underline md:text-lg">Blog</div>
            </Link>
          </div>
        </div>
      </nav>
